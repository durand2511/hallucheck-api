...
OUT="/workspace/rtune7-32b-adapter"
...
cfg=SFTConfig(output_dir=OUT,num_train_epochs=2,per_device_train_batch_size=1,gradient_accumulation_steps=16,
              learning_rate=2e-5,lr_scheduler_type="cosine",warmup_steps=10,logging_steps=10,
...
print("\n===== AA-OMNISCIENCE RONDE7 GENTLE (n="+str(N_Q)+") =====",flush=True)
